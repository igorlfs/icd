...
°°°"""
# |%%--%%| <NJLkxdyDma|gaF091L9KI>

import numpy as np
import matplotlib.pyplot as plt
import pandas as pd

# |%%--%%| <gaF091L9KI|pcDzrQgqrV>
...
# |%%--%%| <pcDzrQgqrV|8oT8m082w7>

plt.ion()
plt.style.use("seaborn-colorblind")

# |%%--%%| <8oT8m082w7|4xdFkeDPkY>
"""°°°
## NumPy Novamente
...
°°°"""
# |%%--%%| <4xdFkeDPkY|I3LGN8W2dV>

ice_cream = [3000, 2600, 1400, 1500, 1200, 500, 300, 400, 700, 600, 800, 1900]
print(ice_cream)

# |%%--%%| <I3LGN8W2dV|hD09dYYiTU>
"""°°°
...
°°°"""
# |%%--%%| <hD09dYYiTU|rXXj8J7lzy>

ice_cream_v = np.array(ice_cream)
print(ice_cream_v)

# |%%--%%| <rXXj8J7lzy|C30u6vqcvP>
"""°°°
...
def median_and_size(array):
    ...
    # return (median, size)
    return np.median(np_v), np_v.size


# |%%--%%| <iL7rd6DiWd|NUVAcJAkQZ>
"""°°°
Novamente, vanos carregar os módulos de testes
°°°"""
# |%%--%%| <NUVAcJAkQZ|FTwgOI9Fe7>
...
# |%%--%%| <FTwgOI9Fe7|FSYgG2FY52>
"""°°°
Nosso teste
°°°"""
# |%%--%%| <FSYgG2FY52|zpzKkUep4g>

median, size = median_and_size(ice_cream_v)
assert_equal(1000, median)
assert_equal(12, size)

# |%%--%%| <zpzKkUep4g|dNWFzoMc3A>

len(ice_cream_v)

# |%%--%%| <dNWFzoMc3A|U2jKrwFXIM>
"""°°°
## Pandas
°°°"""
# |%%--%%| <U2jKrwFXIM|ow897kAMEK>
"""°°°
...
°°°"""
# |%%--%%| <hsl55NfQVM|fmUxvTIph8>

df = pd.DataFrame(
    {
        "icecream": ice_cream,  # coluna 0
...
# |%%--%%| <fmUxvTIph8|fSiEBkMVje>
"""°°°
A chamada head mostra as 5 primeiras linhas do DataFrame. 
°°°"""
# |%%--%%| <fSiEBkMVje|9MpW9VqR5W>

df.head()

# |%%--%%| <9MpW9VqR5W|63QhZ588Nc>
"""°°°
### Exercício 02
...
```
°°°"""
# |%%--%%| <63QhZ588Nc|GGBgt9MkPH>


def month_sales(df, month: str):
    return df[df.index == month].iloc[0]


# |%%--%%| <GGBgt9MkPH|KuLpSg4q0s>
...
°°°"""
# |%%--%%| <ADzIKM9xh6|v0jI2xZhFP>

df = pd.read_csv(
    "https://raw.githubusercontent.com/icd-ufmg/icd-ufmg.github.io/master/listas/l2/snow.csv"
)
df.describe()

# |%%--%%| <v0jI2xZhFP|b6PiUjCiyv>
"""°°°
