...
°°°"""
# |%%--%%| <UGaC40zsEX|Ksg6d5CcEb>
r"""°°°
## Introdução
°°°"""
# |%%--%%| <Ksg6d5CcEb|ou2t3lX52s>
...
# |%%--%%| <ou2t3lX52s|rFjSnmaXSE>

plt.ion()
plt.style.use("seaborn-colorblind")
plt.rcParams["figure.figsize"] = (12, 8)

# |%%--%%| <rFjSnmaXSE|cSI5xAPJ6w>
...
°°°"""
# |%%--%%| <W8gwjoIy5m|Z6Y3B6yCHt>
r"""°°°
## A ideia por trás do gradiente descendente
°°°"""
# |%%--%%| <Z6Y3B6yCHt|ryunQ88kt8>
r"""°°°
...
°°°"""
# |%%--%%| <ryunQ88kt8|mrgCzgzc3B>

df = pd.read_csv(
    "https://raw.githubusercontent.com/pedroharaujo/ICD_Docencia/master/gray-kangaroos.csv",
    names=["comprimento", "largura"],
    header=0,
)
df.head()

# |%%--%%| <mrgCzgzc3B|Yo8kri75Qw>
r"""°°°
Abaixo temos o modelo.
°°°"""
# |%%--%%| <Yo8kri75Qw|ZBtixh0zSD>
...
# |%%--%%| <ZBtixh0zSD|GAXOKs7q5q>
r"""°°°
Z-normalizando temos:
°°°"""
# |%%--%%| <GAXOKs7q5q|wGZheWjCOk>
...
# |%%--%%| <wGZheWjCOk|RK0R0wf7Gc>
r"""°°°
Por fim, a regressão. Note o intercepto igual a 0.
°°°"""
# |%%--%%| <RK0R0wf7Gc|rxSjLyFox1>

y = df["comprimento"]
x = df["largura"]
ss.linregress(x, y)

# |%%--%%| <rxSjLyFox1|WY0ZcpNwTD>
r"""°°°
...
# |%%--%%| <nEG82uoOWV|T0WyG21Fze>
r"""°°°
## Gradiente Descendente
°°°"""
# |%%--%%| <T0WyG21Fze|bDbwZmWI5I>
r"""°°°
...
# |%%--%%| <y5Td2n2TQk|rGZ3KOim14>
r"""°°°
Observe os erros
°°°"""
# |%%--%%| <rGZ3KOim14|Zp0UMvvDS7>
...
# |%%--%%| <Zp0UMvvDS7|abx7gGlH5r>
r"""°°°
## Gradiente Descendente Estocástico
°°°"""
# |%%--%%| <abx7gGlH5r|olNL3x1Fh3>
r"""°°°
...
# |%%--%%| <Qi1BTud8Ok|ExWtLLkkfJ>
r"""°°°
Observe os erros
°°°"""
# |%%--%%| <ExWtLLkkfJ|rlMbUACTiz>
...
# |%%--%%| <rlMbUACTiz|CFF9JJtr6Z>
r"""°°°
## Escolhendo o tamanho certo do passo
°°°"""
# |%%--%%| <CFF9JJtr6Z|thvXv5gOHR>
r"""°°°
...
°°°"""
# |%%--%%| <thvXv5gOHR|sKL1RMHhtw>
r"""°°°
## Caso Multivariado
°°°"""
# |%%--%%| <sKL1RMHhtw|gUqVia5zKp>
r"""°°°
...
# |%%--%%| <Asa5tSepE4|vtw80WVPvt>
r"""°°°
## Exercícios
°°°"""
# |%%--%%| <vtw80WVPvt|rRfgFBucW6>
r"""°°°
### Minimizando funções:
°°°"""
# |%%--%%| <rRfgFBucW6|ZTPRfUXwch>
r"""°°°
Observe a função $f(x,y) = (x+3)^2 + xy + y^2$ cujo gráfico é mostrado abaixo:
°°°"""
# |%%--%%| <ZTPRfUXwch|YvONRudEy3>
...
# |%%--%%| <FI1Xevie2o|mM9HfWofXN>
r"""°°°
### Close Nova Dataset
°°°"""
# |%%--%%| <mM9HfWofXN|ilVukcn2my>
r"""°°°
...
# |%%--%%| <o48XBosH0j|gS2FYgkRQI>

fig = plt.figure()
plt.scatter(
    df.values[:, 0], df.values[:, 1], alpha=0.3
)  # Esse alpha define transparência dos pontos
plt.xlabel("Distance (million parsecs)")
plt.ylabel("Speed (parsecs/year)")
fig.show()

# |%%--%%| <gS2FYgkRQI|dQXiAM81lw>
r"""°°°
...
°°°"""
# |%%--%%| <cVFZCZ3Rkl|gYzVmOrbS7>

from scipy.stats import zscore

# |%%--%%| <gYzVmOrbS7|vcPbNZxqyM>


def z_norm(dataset: pd.DataFrame):
    return dataset.apply(zscore)


# |%%--%%| <vcPbNZxqyM|NLqNN7B092>
...
$$\sum_i (y_i - \bar{y})^2$$
°°°"""
# |%%--%%| <s0UKuyWuhz|q0tqOgNJiw>


def sst(y):
    return ((y - y.mean()) ** 2).sum() - 1


# |%%--%%| <q0tqOgNJiw|NWakKK7ufg>

soma_quadrados = sst(df.values[:, 1])
assert_equal(np.round(soma_quadrados, 4), 155)

# |%%--%%| <NWakKK7ufg|wvBWT85qkD>
r"""°°°
